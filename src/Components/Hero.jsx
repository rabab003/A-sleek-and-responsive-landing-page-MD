...
export default function Hero() {
  return (
    <section className='container mx-auto flex flex-col md:flex-row items-center justify-between pt-44 pb-6 px-4 sm:px-6 lg:px-8'>
        ...
        <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold leading-tight'>Lorem ipsum dolor sit amet consectetur   <span className="text-blue-600 relative inline-block">
