    ...
    <footer className='bg-gray-50'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-16'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12'>
               ...
               <p className='text-gray-600 mb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae quam, nesciunt minus et a unde?</p>

               <div>
                <a href="#" className='w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-100 hover:bg-blue-600 hover:text-white transition-all duration-200'>
